...
1. When you're done:
 ...
 1. Bring your fork up-to-date with the Markdown Preview Plus upstream repo ([see below](#keeping-your-fork-in-sync)). Then rebase your branch on `dev` running `git rebase dev`.
1. `git push`
